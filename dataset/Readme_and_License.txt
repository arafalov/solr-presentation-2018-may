The dataset in this directory is a slightly modified copy of 
the original dataset from the Fake Name Generator with the following parameters:

* Name sets: American, Arabic, Australian, Chinese, French, Hispanic, Polish, Russian, Russian (Cyrillic), Thai
* Countries: Australia, Canada, France, Poland, Spain, United Kingdom, United States
* Age range: 19 - 85 years old
* Gender: 50% male, 50% female
* Quantity: 20,000 identities 

The license chosen was Creative Commons Attribution-Share Alike 3.0 as per the options below.
